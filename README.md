...
- [Exercise 1 - Implement wrapper for Purchase Requisition BAPI BAPI_PR_CREATE](exercises/ex1/)
    ...
    - [Exercise 1.2 - Create wrapper Interface ZIF_BAPI_PR_CREATE_XX](exercises/ex1#exercise-12-create-interface-zif_bapi_pr_create_xx)
    ...
    - [Exercise 1.4 - Create factory Class ZCL_BAPI_WRAP_FACTORY_XX](exercises/ex1#exercise-12-create-factory-class-zcl_bapi_wrap_factory_xx)
